        ...
        <div className={styles.content_wrapper}>
            <div className={styles.secondary_nav}>
                <div className={styles.secondary_nav_inner}>
                    <a href="#collaborate" className={styles.secondary_nav_inner_item1}>Compatibility</a>
                    <a href="#build" className={styles.secondary_nav_inner_item2}>F. Formats</a>
                    <a href="#grow" className={styles.secondary_nav_inner_item3}>Features</a>
                    <a href="#design" className={styles.secondary_nav_inner_item4}>Editions</a>
