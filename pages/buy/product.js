...
//FOR ORGANIZATIONS
    ...
    if (type=='organization') {
        if (billing == 'yearly') {
            cards = options.map((x, i) => <SubscriptionCards title={x.name} description={x.description} price={x.price}
                                                             type={x.type} formats={x.formats}/>)

        } else if (billing == 'monthly') {
            cards = options1.map((x, i) => <SubscriptionCards title={x.name} description={x.description} price={x.price}
                                                              type={x.type} formats={x.formats}/>)

        } else {
            cards = options2.map((x, i) => <SubscriptionCards title={x.name} description={x.description} price={x.price}
                                                              type={x.type} formats={x.formats}/>)

        }
    } else if(type=='personal'){
        if (billing == 'yearly') {
            cards = options3.map((x, i) => <SubscriptionCards title={x.name} description={x.description} price={x.price}
                                                             type={x.type} formats={x.formats}/>)

        } else if (billing == 'monthly') {
            cards = options4.map((x, i) => <SubscriptionCards title={x.name} description={x.description} price={x.price}
                                                              type={x.type} formats={x.formats}/>)

        } else {
            cards = options5.map((x, i) => <SubscriptionCards title={x.name} description={x.description} price={x.price}
                                                              type={x.type} formats={x.formats}/>)
