                                    ...
                                    <div className={styles.client_order_summary_content_total}>
                                        <div className={styles.client_order_summary_content_total_content}>
                                            <div className={styles.client_order_summary_content_total_content_inner}>
                                                ...
                                                <small className={styles.client_order_summary_content_total_content_inner_price}>€100.00</small>

                                            </div>
                                            <div className={styles.client_order_summary_content_total_content_inner}>
                                                <small>VAT 25%:</small>
                                                <small className={styles.client_order_summary_content_total_content_inner_price}>€25.00</small>

                                            </div>
                                            <div className={styles.client_order_summary_content_total_content_inner} style={{fontWeight:'800'}}>
                                                <span>Total:</span>
                                                <span className={styles.client_order_summary_content_total_content_inner_price}>€125.00</span>
