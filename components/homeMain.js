      ...
      <div className={styles.landing}>
        ...
        <div className={styles.products_outer}>
          <div className={styles.products}>
            <input
              className={`${styles.radio} ${styles.r1}`}
              type="radio"
              name="slider"
              id="item-1"
              onClick={() => {
            ...
            />
            <input
              className={`${styles.radio} ${styles.r2}`}
              type="radio"
              name="slider"
              id="item-2"
              onClick={() => {
            ...
            />
            <input
              className={`${styles.radio} ${styles.r3}`}
              type="radio"
              name="slider"
              id="item-3"
              defaultChecked
            ...
            />
            <input
              className={`${styles.radio} ${styles.r4}`}
              type="radio"
              name="slider"
              id="item-4"
              onClick={() => {
            ...
            <label
              id="slide3"
              htmlFor="item-3"
              className={`${styles.product_card} ${styles.eztitles_card}`}
            >
              ...
              <div className={styles.card_description}>
                <p>
                  ...
                  do! Word-class TV, Digital Cinema, DVD and Blu-ray subtitle
                  preparation software. Powerful conversion tool for almost any
                  known file format. Breakthrough module for Closed Captioning.
                  Three groundbreaking products. Single software.
                </p>
              </div>
              <div className={styles.card_button}>
                <Link href="/subtitle">
                  <a className={styles.card_button_inner}>Learn More</a>
                </Link>
              </div>
            ...
            <label
              id="slide2"
              htmlFor="item-2"
              className={`${styles.product_card} ${styles.ezconvert_card}`}
            >
              <div className={styles.product_card_icon}>
                <MyImage
                  src="/images/ezc.png"
            ...
            <label
              id="slide1"
              htmlFor="item-1"
              className={`${styles.product_card} ${styles.titles3d_card}`}
            >
              <div className={styles.product_card_icon}>
                <MyImage
                  src="/images/3d.png"
              ...
              <div className={styles.card_description}>
                <p>
                  ...
                  analyzes the whole movie and automatically choses the perfect
                  Z-position for each subtitle. Or YOU can do it according to
                  point of interest in the picture.
                </p>
              </div>
              <div className={styles.card_button}>
                <Link href="/products/plugins">
            ...
            <label
              id="slide4"
              htmlFor="item-4"
              className={`${styles.product_card} ${styles.plugin_card}`}
            >
              <div className={styles.product_card_icon}>
                <MyImage
                  src="/images/ep.png"
              ...
              <div className={styles.card_description}>
                <p>
                  The plug-ins for ProMedia Carbon, Rhozet&apos; Carbon Coder,
                  Adobe® Premiere® Pro, Avid® Media Composer® and Capella
                  Systems Cambria File Convert are powerful tools which allows
                  you to load and encode (burn) your subtitles Closed Caption,
